  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relative'>
      ...
      <div className='flex'>
        ...
        <NavButton title="Chat" customFun={() => handleClick('chat')} color={currentColor} dotColor="#03c9d7" icon={<BsChatLeft />} />
        <NavButton title="Notifications" customFun={() => handleClick('notification')} dotColor="#03c9d7" color={currentColor} icon={<RiNotification3Line />} />
